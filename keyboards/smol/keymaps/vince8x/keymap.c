...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 // |___________________________________________________________________________________________________|
    [_NVIM] = LAYOUT_wrapper(
 // |___________________________________________________________________________________________________|
      ___________________NVIM_L1_____________________ , ___________________NVIM_R1_____________________ ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      ___________________NVIM_L2_____________________ , ___________________NVIM_R2_____________________ ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      ___________________NVIM_L3_____________________ , ___________________NVIM_R3_____________________ ,
 // |---------+---------+---------+---------+---------+---------+---------+---------+---------+---------|
      ___________________NVIM_L4_____________________ , ___________________NVIM_R4_____________________),
 // |___________________________________________________________________________________________________|
};
