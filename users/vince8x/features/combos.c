...
// Base
const uint16_t l_base_tab_combo[] PROGMEM  = {LCTLT_W, KC_F, COMBO_END};
...
// Qwerty
const uint16_t l_qwerty_tab_combo[] PROGMEM  = {LCTLT_W, KC_E, COMBO_END};
...
// Navigation
const uint16_t l_nav_tab_combo[] PROGMEM  = {CST_TAB, LCTRL_TAB, COMBO_END};
