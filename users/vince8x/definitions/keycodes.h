...
#define QHOME_Z LT(_TMUX, KC_Z)
#define QHOME_X LT(_TMUX, KC_X)
#define QHOME_SL LT(_TMUX, KC_SLSH)
#define QHOME_DOT LT(_TMUX, KC_DOT)
#define QHOME_V LT(_NVIM, KC_V)
#define QHOME_M LT(_NVIM, KC_M)
