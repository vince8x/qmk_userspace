...
#define ___________________TMUX_R1_____________________   TM_JUMP       , TM_MARK      , TM_UNMARK       , TM_COPY       , TM_SW_W
#define ___________________TMUX_R2_____________________   TM_RESIZE_L   , TM_RESIZE_D  , TM_RESIZE_U     , TM_RESIZE_R   , TM_CYCLE
#define ___________________TMUX_R3_____________________   TM_CP_MODE    , TM_VSPLIT    , TM_FZF_URL      , TM_FZF_NOVA   , TM_P_TO_W
