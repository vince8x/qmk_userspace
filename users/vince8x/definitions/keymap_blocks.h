...
#define ___________________BASE_L2_____________________   HOME_A  , LALTT_R , LCTLT_S , LSFTT_T , KC_G
#define ___________________BASE_L3_____________________   HOME_Z  , KC_X    , KC_C    , KC_D    , KC_V
#define ___________________BASE_L4_____________________                       SYM_REP , NAV_SPC , KC_SPC
#define ___________________BASE_R1_____________________   KC_J    , KC_L    , KC_U    , KC_Y    , KC_SCLN
#define ___________________BASE_R2_____________________   KC_M    , RSFTT_N , RCTLT_E , RALTT_I , HOME_O
#define ___________________BASE_R3_____________________   KC_K    , KC_H    , KC_COMM , KC_DOT  , HOME_SL
#define ___________________BASE_R4_____________________   MO_FUN  , SF_ENT , NUM_BSPC

#define ___________________QWERTY_L1___________________   KC_Q    , LCTLT_W , KC_E    , KC_R    , KC_T
#define ___________________QWERTY_L2___________________   QHOME_A , QHOME_S , QHOME_D , QHOME_F , KC_G
#define ___________________QWERTY_L3___________________   QHOME_Z , KC_X    , KC_C    , KC_V    , KC_B
#define ___________________QWERTY_L4___________________                       SYM_REP , NAV_SPC , KC_SPC
#define ___________________QWERTY_R1___________________   KC_Y    , KC_U    , KC_I    , KC_O    , KC_P
#define ___________________QWERTY_R2___________________   KC_H    , QHOME_J , QHOME_K , QHOME_L , QHOME_SC
#define ___________________QWERTY_R3___________________   KC_N    , KC_M    , KC_COMM , KC_DOT  , QHOME_SL
#define ___________________QWERTY_R4___________________   KC_ENT  , SF_ENT , NUM_BSPC


#define ___________________NUM_L1______________________   LSFT(KC_GRV), KC_AT   , KC_HASH , KC_DLR       , KC_T
#define ___________________NUM_L2______________________   KC_ASTR     , KC_PERC , KC_CIRC , KC_AMPR      , KC_COLN
#define ___________________NUM_L3______________________   LSFT(KC_GRV), KC_GRV  , KC_C    , LSFT(KC_MINS), KC_B
...
#define ___________________SYM_R3______________________   KC_TILDE    , KC_PIPE , KC_LCBR    , KC_RCBR         , KC_SLSH
#define ___________________SYM_R4______________________   KC_ENT      , KC_BSPC , XXXXXXX
...
#define ___________________FUN_L3______________________   XXXXXXX     , XXXXXXX , XXXXXXX    , KC_MINS         , XXXXXXX
...
#define ___________________NAV_L1______________________   LCTRL_TAB   , LCTRL_TAB , KC_UP      , KC_PGUP         , KC_HOME
...
#define ___________________NAV_R1______________________   COPY        , KC_PGUP   , KC_HOME    , REDO         , UNDO
#define ___________________NAV_R2______________________   PAST        , KC_DOWN   , KC_UP      , KC_RIGHT        , CW_TOGG
#define ___________________NAV_R3______________________   KC_INS      , KC_PGDN   , KC_END     , KC_RCBR         , KC_SLSH
